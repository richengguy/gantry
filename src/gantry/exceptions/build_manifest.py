...
class BuildManifestBadFilePathError(BuildManifestException):
    ...
    def __init__(self, key: str, expected: str, actual: str) -> None:
        ...
        self.actual = actual
        super().__init__(f'"The file {key} points to should be {expected}, was {actual}.')
...
class BuildManifestValidationError(BuildManifestException):
    ...
    def __init__(self, errors: list[ValidationError]) -> None:
        ...
        msg = str(errors[0]) if len(errors) == 1 else f'Found {len(errors)} errors in build manifest.'  # noqa: E501
        super().__init__(msg)
